...
function setPanelExpanded(expanded){detailPanel.classList.toggle("expanded",expanded);document.body.classList.toggle("panel-expanded",expanded);panelExpand.setAttribute("aria-expanded",String(expanded));panelExpandLabel.textContent=expanded?"Details invouwen":"Bekijk details";panelExpandIcon.textContent=expanded?"↓":"↑";}
